...
const loadProducts = () => {
    products = [new Xperience('Enjoy a day at Serenity Spa!','Spa day','The spa\'s facilities include a jacuzzi, a relaxation area, a sauna, an aromatherapy steam room and a pool looking out over the Danish countryside.You can choose a 60-minute treatment from the treatment menu - we like the sound of the Sensory Body Massage with Hot Stones, the Raindrop Massage or the English Rose Radiance Facial. The Serenity Spa Guide praises the venue\'s "countryside views" and "floor-to-ceiling windows" that "fill the pool and Jacuzzi area with natural light" ' 
                ...
                ,250, './Pictures/xp2.jpg','./Pictures/Rating1.png', 'xpCPH2','"Amazing experience, highly recommend! - John, New York"'),
                ...
                ,299, './Pictures/xp3.jpg','./Pictures/Rating2.png','xpCPH3','"Amazing experience, highly recommend! - John, New York"'),
                ...
                ,199, './Pictures/xp4.jpg','./Pictures/Rating2.png','xpOSL1','"Amazing experience, highly recommend! - John, New York"'),
                ...
                ,350, './Pictures/xp5.jpg','./Pictures/Rating1.png','xpOSL2','"Amazing experience, highly recommend! - John, New York"'),
                ...
                ,899, './Pictures/xp6.jpg','./Pictures/Rating1.png','xpOSL3','"Amazing experience, highly recommend! - John, New York"'),
                ...
                ,150, './Pictures/xp7.jpg','./Pictures/Rating2.png', 'xpSTK1','"Amazing experience, highly recommend! - John, New York"'),
                ...
                ,200, './Pictures/xp8.jpg','./Pictures/Rating2.png','xpSTK2','"Amazing experience, highly recommend! - John, New York"'),
                ...
                ,499, './Pictures/xp9.jpg','./Pictures/Rating1.png','xpSTK3','"Amazing experience, highly recommend! - John, New York"')]
            }
